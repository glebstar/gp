...
function t_animate__startAnimation() {
    var t = $(".r").has(".t-animate[data-animate-group=yes]"), a = $(".r").has(".t-animate[data-animate-chain=yes]"),
    ...
    $(window).width() < 1200 && (t = t_animate__checkMobile(t), a = t_animate__checkMobile(a), e = t_animate__checkMobile(e)), (void 0 !== t && 0 != t.length || void 0 !== e && 0 != e.length || void 0 !== a && 0 != a.length) && (t_animate__setAnimationState(t, a, e), t = t.filter(".r:has(.t-animate_wait)"), e = e.filter(".t-animate_wait"), a = a.filter(".r:has(.t-animate_wait)"), n(), $(window).bind("resize", t_throttle(n, 200)), setInterval(n, 5e3), $(window).bind("scroll", t_throttle(function () {
        ...
        0 !== a.length && (t_animate__setAnimationStateChains(a), t_animate__getChainOffsets(a = a.filter(".r:has(.t-animate_wait)")), t_animate__animateChainsBlocks(a, t))
    }, 200)))
}
...
function t_animate__animateGroups(t, a) {
    if (t.length) for (var e, n, i = 0; i < t.length; i++) t[i].curTopOffset < a && (n = (e = $(t[i])).find(".t-animate:not([data-animate-chain=yes])"), t_animate__makeSectionButtonWait(e), n = n.filter(".t-animate:not(.t-animate__btn-wait-chain)"), t_animate__saveSectionHeaderStartTime(e), n.removeClass("t-animate_wait"), t_animate__removeNoHoverClassFromBtns(n), n.addClass("t-animate_started"), t.splice(i, 1), i--)
}
...
function t_animate__animateChainItemsOnScroll(t, a, e) {
    var n = $(t[a]), i = n.find(".t-animate_wait[data-animate-chain=yes]"), s = 0, r = 0, o = t[a].itemsOffsets[0],
        m = t_animate__getDelayFromPreviousScrollEvent(n, i, .16), _ = t_animate__getSectionHeadDealy(n);
...
function t_animate__getSectionHeadDealy(t) {
    var a = t.find(".t-section__title.t-animate"), e = t.find(".t-section__descr.t-animate"), t = 0;
    return a.length && Date.now() - a.attr("data-animate-start-time") <= 160 || e.length && Date.now() - e.attr("data-animate-start-time") <= 160 ? t = .16 : t
}

function t_animate__getDelayFromPreviousScrollEvent(t, a, e) {
    var n = 0 == t.find(".t-animate_started").length,
        t = t.find(".t-animate__chain_first-in-row.t-animate_started:not(.t-animate__chain_showed)");
    if (n || 0 == t.length) return 0;
    t = t.last().attr("data-animate-start-time") - Date.now();
...
function t_animate__parseNumberText(t) {
    ...
    t.each(function () {
        var t, a, e, n = $(this), i = "", s = "";
        0 !== n.find('div[data-customstyle="yes"]').length ? (s = "", n.find("span").each(function () {
            s += $(this).attr("style"), $(this).removeAttr("style"), $(this).removeAttr("data-redactor-style")
        }), i = n.find('div[data-customstyle="yes"]').html(), e = n.attr("style"), e += n.find("div[data-customstyle]").attr("style"), n.attr("style", e)) : (n.find("span").each(function () {
            s += $(this).attr("style"), $(this).removeAttr("style"), $(this).removeAttr("data-redactor-style")
        }), i = n.html()), s = s.split(";").filter(function (t, a) {
            return s.split(";").indexOf(t) === a
        }).join(";"), $(this).offset().top < r - 500 || 0 < i.length && (a = i.replace(/[^\d\.\,\ ]+/g, "").match(/\d+\.\d+|\d+\,\d+/g), e = removeNumberSpace = i.replace(/<br>/g, " ").replace(/[^\d\.\,\ ]+/g, "").replace(/ (\.|,)/g, "").replace(/(\d)(?=\d) /g, "$1").trim(), -1 === i.indexOf(e) && (nremoveNumberSpace = numbe = e.split(" ")[0]), "" !== e && (n.attr("data-animate-number-count", i), null !== a && (-1 !== e.indexOf(",") && (t = e.split(",")), -1 !== e.indexOf(".") && (t = e.split(".")), -1 === e.indexOf(",") && -1 === e.indexOf(".") || (a = t[1].length, e = (e = +t.join(".")).toFixed(a))), t_animate__changeNumberOnZero(n, i.replace(removeNumberSpace, "num")), n.find("span:not(.t-animate__number)").each(function () {
            $(this).attr("style", s)
        })))
    })
}
...
function t_animate__changeNumberOnZero(t, a) {
    a = a.replace(/num/g, '<span class="t-animate__number">0</span>');
    t.html(a)
}

function t_animate__animateNumbers(t) {
    t.each(function () {
        var n, s, t, i, r, o, a, m = $(this), e = m.attr("data-animate-number-count"), _ = [];
        m.find("span:not(.t-animate__number):first").each(function () {
            _ = $(this).attr("style")
        }), e && (n = e.match(/\d+\.\d+|\d+\,\d+/g), s = e.match(/\d+/g), t = e.replace(/(\d)(?= \d) /g, "$1").split(" "), i = [], t.forEach(function (t, a) {
            isNaN(parseInt(t.replace(/[^\d\.\,\ ]+/g, ""), 10)) || i.push(t.replace(/[^\d\.\,\ ]+/g, ""))
        }), r = 0, o = !1, m.removeAttr("data-animate-number-count"), null !== n && (o = -1 != n[0].indexOf(",")), i.forEach(function (t, a) {
            var e;
            null !== n && (-1 !== t.indexOf(",") && (e = t.split(",")), -1 !== t.indexOf(".") && (e = t.split(".")), -1 === t.indexOf(",") && -1 === t.indexOf(".") || (r = e[1].length, i[a] = +e.join(".")))
        }), a = [], m.find(".t-animate__number").each(function () {
            a.push($(this).text())
        }), i.forEach(function (n, i) {
            void 0 !== a[i] && $({animateCounter: a[i]}).animate({animateCounter: n}, {
                duration: 1500,
                easing: "swing",
                step: function (t) {
                    var a = m.find(".t-animate__number")[i], e = Math.pow(10, r),
                        e = t ? (Math.round(this.animateCounter * e) / e).toFixed(r) + "" : Math.floor(this.animateCounter) + "";
                    1 < s.length && (e = e.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ")), o && (e = e.replace(/\./g, ","), n = (n + "").replace(/\./g, ",")), $(a).text(e)
                },
                complete: function () {
                    m.html(e), m.find("span").each(function () {
                        $(this).attr("style", _)
                    })
                }
            })
...
function t_animate__setAnimationState(t, a, e) {
    ...
    t.each(function () {
        ...
        if (t_animate__removeAnimFromHiddenSlides(t), t_animate__assignGroupDelay(t, t_animate__assignSectionDelay(t)), a.hasClass("t-animate_no-hover") && 1 === a.parents(".t400__off").length && a.removeClass("t-animate_no-hover"), e <= n - 100) return t_animate__saveSectionHeaderStartTime(t), a.removeClass("t-animate t-animate_no-hover"), a.css("transition-delay", ""), !0;
...
function t_animate__assignOrderedElemsDelay(t, a) {
    ...
    var n = t.find(".t-animate[data-animate-order=1]"), i = t.find(".t-animate[data-animate-order=2]"),
        ...
        a = t.find(".t-animate[data-animate-order=5]");
...
function t_animate__assignChainDelay(e, n, i) {
    var s, r, o = e.find(".t-animate[data-animate-chain=yes]"), m = 0;
    0 != o.length && (s = $(o[0]).offset().top, $(o[0]).addClass("t-animate__chain_first-in-row"), r = t_animate__getCurBlockSectionHeadDelay(e), o.each(function () {
        var t = $(this), a = t.offset().top;
        if (a < i) return t.removeClass("t-animate"), !0;
        a < n ? (a != s && (t.addClass("t-animate__chain_first-in-row"), s = a), a = .16 * m + r, t.css("transition-delay", a + "s"), t.addClass("t-animate_started"), t.attr("data-animate-start-time", Date.now() + 1e3 * a), t[0] == o.last()[0] && t_animate__checkSectionButtonAnimation(e, a), m++, t.on("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", function (t) {
            $(this).addClass("t-animate__chain_showed"), $(this).off("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd")
        })) : t.addClass("t-animate_wait")
    }))
}
...
function t_animate__setCustomAnimSettings(t, a, e) {
    ...
    i = t_animate__getAttrByRes(t, "scale");
    void 0 !== i && "" != i && (t.css({
        "transition-duration": "0s",
        "transition-delay": "0s"
    }), t.css("transform", "scale(" + i + ")"), t_animate__forceElemInViewPortRepaint(t, a, e), t.css({
        "transition-duration": "",
        "transition-delay": ""
    }));
    e = t_animate__getAttrByRes(t, "delay");
    void 0 !== e && "" != e && t.css("transition-delay", e + "s");
    e = t_animate__getAttrByRes(t, "duration");
    void 0 !== e && "" != e && t.css("transition-duration", e + "s")
}
...
function t_animate__detectElemTriggerOffset(t, a) {
    var e = t_animate__getAttrByRes(t, "trigger-offset"), t = a;
    return void 0 !== e && "" != e && (t = a - +(e = e.replace("px", ""))), t
}

function t_animate__saveSectionHeaderStartTime(t) {
    var a = t.find(".t-section__title.t-animate"), t = t.find(".t-section__descr.t-animate");
    a.length && a.attr("data-animate-start-time", Date.now()), t.length && t.attr("data-animate-start-time", Date.now() + 160)
}
...
function t_animate__makeSectionButtonWait(t) {
    var a = t.find(".t-animate[data-animate-chain=yes]").length,
        t = t.find(".t-section__bottomwrapper .t-btn.t-animate");
    a && t && t.addClass("t-animate__btn-wait-chain")
}

function t_animate__checkSectionButtonAnimation(t, a) {
    t = t.find(".t-animate__btn-wait-chain");
    t.length && (t.css("transition-delay", a + .16 + "s"), t_animate__removeNoHoverClassFromBtns(t), t.removeClass("t-animate__btn-wait-chain"), t.addClass("t-animate_started"))
}

function t_animate__checkSectionButtonAnimation__outOfTurn(t) {
    0 === t.find(".t-animate[data-animate-chain=yes]:not(.t-animate_started)").length && t_animate__checkSectionButtonAnimation(t, .16)
}
...
function t_animate__wrapTextWithOpacity() {
    $(".t-title.t-animate,.t-descr.t-animate,.t-uptitle.t-animate,.t-text.t-animate").each(function (t, a) {
        var e = $(this).attr("style");
        void 0 !== e && 0 <= e.indexOf("opacity") && (void 0 !== (e = $(a).css("opacity")) && 0 < e && ($(a).css("opacity", ""), $(a).wrapInner('<div style="opacity: ' + e + '"></div>')))
    })
}

function t_animate__checkIE() {
    var t, a = window.navigator.userAgent, e = a.indexOf("MSIE"), n = !1;
    return 0 < e && (8 != (t = parseInt(a.substring(e + 5, a.indexOf(".", e)))) && 9 != t || (n = !0)), n
}
