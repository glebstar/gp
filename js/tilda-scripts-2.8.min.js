...
window.isSearchBot = !1, /Bot/i.test(navigator.userAgent) && (window.isSearchBot = !0), window.isMobile = !1, window.$isMobile = !1, /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (window.isMobile = !0, window.$isMobile = !0), window.isiOS = !1, /iPhone|iPad|iPod/i.test(navigator.userAgent) && (window.isiOS = !0), window.isiOSVersion = "", !window.isiOS || null !== (version = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)) && (window.isiOSVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]), window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, function (u) {
    ...
    function S(e) {
        var t = C("#rec" + e), e = t.find(".t-cover").height(), o = t.find("div[data-hook-content]").outerHeight();
    ...
    function l(e, t, o, i) {
        var r = e.offset().top, n = e.height(), a = t.scrollTop(), e = t.height(), t = o.getPlayerState();
    ...
    e.prototype.defaultConfig = {
        ...
        var i = t.querySelector('[data-hook="sequence-holder"]'), a = 0, r = this.getAbsoluteTopOffset(i),
            n = function () {
        ...
        for (var t, o, i, r, n = e.items, a = null, c = 0, d = n.length; c < d; c++) if ((t = n[c].node).querySelector(".txt-holder"), (r = t.getBoundingClientRect()).top < this.itemTransitionTop && r.bottom < r.height + this.itemTransitionTop && r.bottom > this.itemTransitionTop) {
            a = c;
            break
        }
        if (null != a) {
        ...
        this._scrollCb = jQuery.proxy(this.scrollCb, this), C(window).bind("scroll", t_throttle(this._scrollCb, 200))
        ...
        C(document).ready(function () {
            var e, t, o, i, r = document.body.querySelector("#coverCarry" + T), n = C(r),
                a = n.attr("data-content-cover-bg"), c = n.attr("data-content-cover-height"),
                d = n.attr("data-content-cover-parallax"), s = n.attr("data-content-video-url-mp4"),
                l = n.attr("data-content-video-url-webm"), p = n.attr("data-content-video-url-youtube"),
                u = n.attr("data-content-video-noloop"), h = n.attr("data-content-video-nomute"),
                m = n.attr("data-content-bg-base64"), f = n.attr("data-content-video-nocover"), a = a || "",
                c = c || "", d = d || "", s = s || "", l = l || "", u = u || "", h = h || "";
            p = (p = p || "") || "", m = m || "", f && "yes" == f && (p = l = s = ""), !window.isMobile || "" == l && "" == s && "" == p || n.css("background-image", "url('" + a + "')"), setTimeout(function () {
                S(T), q(T)
            }, 500), O(k = T) && (e = document.body.querySelector("#rec" + k), o = document.body.querySelector("#rec" + k + " .t-cover").parentNode, console.log("new fix node background-position: fixed"), window.cover_fixBackgroundStyles || (i = ".t-cover__container {position: relative;}.t-cover__container .t-cover {clip: rect(0, auto, auto, 0);position: absolute;top: 0;left: 0;width: 100%;height: 100% !important;}.t-cover__container .t-cover .t-cover__carrier {position: fixed;display: block;top: 0;left: 0;width: 100%;height: 100%!important;background-size: cover;background-position: center center;transform: translateZ(0);will-change: transform;}", f = document.head || document.getElementsByTagName("head")[0], t = document.createElement("style"), f.appendChild(t), t.type = "text/css", t.styleSheet ? t.styleSheet.cssText = i : t.appendChild(document.createTextNode(i)), window.cover_fixBackgroundStyles = !0), (t = document.createElement("div")).classList.add("t-cover__container"), o.prepend(t), i = e.querySelector(".t-cover"), o = i.style.height, t.style.height = o, t.append(i), void 0 !== (i = {
                275: ".t256__video-container",
                286: ".t266__video-container",
                337: ".t-container",
                906: ".t906__video-container"
            }[e.getAttribute("data-record-type")]) && (i = e.querySelector(i), t.append(i)), window["cover" + k + "fixbackgroundnodes"] = !0);
            var w, g, v, y, b, _, x, k = C("#rec" + T).find("img[data-hook-clogo]");
            k.length && k.load(function () {
                setTimeout(function () {
                    S(T), q(T)
                }, 500)
            }), window.isMobile && C(window).on("orientationchange", function () {
                S(T), q(T)
            }), "" === s && "" === l && "" === p || 0 == window.isMobile && ("" != p || "" == s && "" == l ? "" != p && (n.css("background-color", "#000000"), n.css("background-image", ""), n.attr("data-content-cover-bg", ""), b = 0, (_ = C(window)).scroll(function () {
                ...
                y && window.clearTimeout(y), y = window.setTimeout(function () {
                    var e, t, o;
                    0 < b || (e = n.offset().top, t = n.height(), e - 500 < (o = _.scrollTop()) + _.height() && o <= e + t + 500 && ((t = n.videoBG({
                        mp4: s,
                        webm: l,
                        poster: "",
                        preload: "none",
                        ...
                        zIndex: 0,
                        width: "100%"
                    })).setAttribute("muted", g), t.setAttribute("playsinline", ""), videoLoadProcessor.registerNewVideo(t), b = 1))
            ...
            }), _.scroll())), "dynamic" == d && 0 == window.isMobile && (h = n.offset().top - (n.offset().top - C(window).height()), n.height() < C(window).height() && n.height(n.height() + .2 * h), n.parallax(.2, !0)), "yes" == m && "" != a && "" == s && "" == l && "" == p && (C("<img/>").attr("src", a).load(function () {
                C(this).remove(), n.css("background-image", "url('" + a + "')"), n.css("opacity", "1")
    ...
    function c(e, t) {
        ...
        var o, i, r, n, a = e.find("iframe"), c = e.attr("data-content-video-nocover"),
            d = e.attr("data-content-video-noadcut-youtube"), s = e.attr("data-content-video-ratio"), l = .5625;
    ...
    window.processYoutubeVideo = function (s, a) {
        ...
        o.then(function () {
            var t, e = C(s), o = e.attr("data-content-video-url-youtube"), d = e.attr("data-content-video-nomute"),
                i = e.attr("data-content-video-noloop"), r = e.attr("data-content-video-nocover"),
            ...
            n.src = function (e, t, o) {
                ...
                events: {
                    onReady: function (e) {
                        var t, o, i, r, n, a, c;
                        t = s, o = e.target, i = d, n = C(window), a = C(t), c = 0, n.scroll(function () {
    ...
    e.prototype.defaultConfig = {single: !1, context: null}, e.prototype.addEventListener = function (e, t, o) {
    ...
    r(document).ready(function () {
        function e() {
            if (o.length) for (var e, t = o.length - 1; 0 <= t; t--) (e = r(o[t])).offset().top < (e.outerHeight() <= 100 ? i.scrollTop() + i.height() : i.scrollTop() + i.height() - 100) && (e.removeClass("r_hidden"), e.addClass("r_showed"), o.splice(t, 1))
        }
    ...
    l.fn.videoBG = function (e, t) {
        t = {};
        if ("object" == typeof e) t = l.extend({}, l.fn.videoBG.defaults, e); else {
        ...
        if (o.length) {
            ...
            return t.scale && e.height(t.height).width(t.width), o.append(e), void 0 === o.attr("data-content-video-nomute") && o.find("video").prop("muted", "true"), function (e, t) {
                var o = e.closest(".t-cover__carrier"), i = t + "";
                console.log("setWidthHeightHTMLVideo:" + i);
                var r, n, a = o.find("video"), c = o.attr("data-content-video-nocover"),
                    d = o.attr("data-content-video-ratio"), s = .5625;
        ...
        var t, o = l(window).width(), i = l(window).height();
    ...
    var d = c(window), s = d.height();
    d.resize(function () {
        s = d.height()
    }), c.fn.parallax = function (r, e) {
        var n, t = c(this), a = void 0 !== document.body.style["-webkit-transform"];

        function o() {
            var i = d.scrollTop();
            t.each(function () {
                var e = c(this), t = e.offset().top, o = n(e), e = this.getBoundingClientRect();
...
}(jQuery), window.Tilda = window.Tilda || {}, function (v) {
    Tilda.sendEcommerceEvent = function (e, t) {
        ...
        if (o = o || window.location.href, 0 < (i = i ? parseFloat(i) : 0)) if (window.dataLayer || (window.dataLayer = []), -1 != e.indexOf("/tilda/") && -1 != e.indexOf("/payment/") && window.tildaForm && "" < window.tildaForm.orderIdForStat) o = {
            ecommerce: {
                purchase: {
                    actionField: {
        ...
        }, window.tildaForm.tildapayment && window.tildaForm.tildapayment.promocode && (o.ecommerce.purchase.actionField.coupon = window.tildaForm.tildapayment.promocode), o.event = "purchase"; else if (o && o.ecommerce && (o.ecommerce.add && o.ecommerce.add.products ? a = o.ecommerce.add.products : o.ecommerce.remove && o.ecommerce.remove.products ? a = o.ecommerce.remove.products : o.ecommerce.detail && o.ecommerce.detail.products && (a = o.ecommerce.detail.products), a && 0 < a.length)) {
        ...
        if (window.mainMetrikaId && 0 < window.mainMetrikaId && "function" == typeof ym && (n ? (r = {title: t}, 0 < i && (r.params = {order_price: i}, l && (r.params.currency = l)), ym(window.mainMetrikaId, "hit", e, r)) : 0 < i ? (r = {order_price: i}, l && (r.currency = l), ym(window.mainMetrikaId, "reachGoal", e, r)) : ym(window.mainMetrikaId, "reachGoal", e)), "" < window.mainMetrika && window[window.mainMetrika] && (n ? 0 < i ? window[window.mainMetrika].hit(e, {
            title: t,
            order_price: i,
            params: o
        }) : window[window.mainMetrika].hit(e, {title: t}) : 0 < i ? window[window.mainMetrika].reachGoal(e, {
            title: t,
            params: o,
            order_price: i
        }) : window[window.mainMetrika].reachGoal(e, {title: t, referer: o})), null != window.fbq && 0 == d) try {
            if (n) if (-1 == e.indexOf("tilda/") || -1 == e.indexOf("/payment/") && -1 == e.indexOf("/submitted/")) if (o && o.event && 0 < i) if ("addToCart" == o.event && o.ecommerce.add) {
                var p = o.ecommerce.add.products.length, u = [];
        ...
        if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && 0 == s) try {
            if (n) {
                ...
                if (o && o.event) if (f = {
                    ...
                    currency_code: "",
                    total_price: 0
                }, "purchase" == o.event && o.ecommerce.purchase) if (0 < i && 0 < h) {
                    f.currency_code = l;
                    ...
                    m = "init_checkout"
                } else m = "t-purchase"; else if ("addToCart" == o.event && o.ecommerce.add) if (0 < i && 0 < h) {
                    f.currency_code = l;
                    ...
                    m = "add_to_cart"
                } else m = "t-add-to-cart", o.ecommerce.add[0] && o.ecommerce.add[0].uid && (m += "-" + o.ecommerce.add[0].uid); else if ("viewProduct" == o.event && o.ecommerce.detail) if (0 < i && 0 < h) {
                    f.currency_code = l;
                    p = o.ecommerce.detail.products.length, u = [];
                    ...
                    m = "view_product"
                } else m = "t-view-product", o.ecommerce.detail[0] && o.ecommerce.detail[0].uid && (m += "-" + o.ecommerce.detail[0].uid); else if ("removeFromCart" == o.event && o.ecommerce.remmove) if (0 < i && 0 < h) {
                    f.currency_code = l;
                    var w, g, p = o.ecommerce.remove.products.length, u = [];
                    for (g = 0; g < p; g++) w = o.ecommerce.remove.products[g], f.products.push({
                        id: w.id || w.uid || w.name,
                        price: w.price || 0
                    }), f.total_price = i;
                    m = "remove_from_cart"
                } else m = "t-remove-product", o.ecommerce.remove[0] && o.ecommerce.remove[0].uid && (m += "-" + o.ecommerce.remove[0].uid); else m = o.event; else m = -1 != e.indexOf("tilda/") && -1 != e.indexOf("/payment/") ? "t-purchase-" + e.replace("tilda/", "").replace("/payment/", "") : -1 != e.indexOf("tilda/") && -1 != e.indexOf("/submitted/") ? "t-lead-" + e.replace("tilda/", "").replace("/submitted/", "") : -1 != e.indexOf("tilda/popup") || -1 != e.indexOf("tilda/click") ? "t-" + e.replace("tilda/", "").replace("/", "-") : "t-" + e.replace("/", "-");
        ...
        "0" < window.mainMailruId && (s = window._tmr || (window._tmr = []), n ? 0 < i ? s.push({
            ...
            type: "reachGoal",
            goal: e
        })), "function" == typeof window.tildastat && (n ? (0 < e.indexOf("payment") && -1 < e.indexOf("tilda/form") && (e = e.replace("tilda/form", "tilda/rec")), window.tildastat("pageview", {page: e})) : window.tildastat("pageview", {page: "/tilda/event/" + e}))
        ...
        var e = navigator.userAgent.toLowerCase(), e = -1 != e.indexOf("msie") && parseInt(e.split("msie")[1]);
        ...
        v(".r").off("click", "a.js-click-stat"), v(".r").on("click", "a.js-click-stat", function (e) {
            var t = v(this).data("tilda-event-name"), o = v(this).text(), r = v(this).attr("href") || "",
                n = v(this).attr("target"), t = t || "/tilda/click/".$(this).closest(".r").attr("id") + "/?url=" + r;
    ...
    o(document).ready(function () {
        setTimeout(function () {
            (o("#tildacopy").length || o(".t-tildalabel").length) && o(".t-tildalabel div").length ? o("body").height() + 70 < o(window).height() || o(".t-tildalabel").attr("style", "display: block !important; visibility: visible !important; position: relative !important; width: 100% !important; pointer-events: all !important; opacity: 1 !important") : o("body").contents().filter(function () {
