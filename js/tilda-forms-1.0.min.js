(function (t) {
    ...
    var e, r = navigator.userAgent, a = /iphone/i.test(r), o = /chrome/i.test(r), i = /android/i.test(r);
    t.mask = {
        ...
        caret: function (t, e) {
            ...
            return n = t.extend({
                ...
                completed: null
            }, n), d = t.mask.definitions, l = [], c = p = r.length, m = null, r = String(r), t.each(r.split(""), function (t, e) {
                ...
                function j(e) {
                    var r = T.val(), a = T.caret(), o = function () {
                        t.proxy(t.fn.caret, T, a.begin, a.begin)()
                    };
                    if (f && f.length && f.length > r.length) {
                        for (var i = _(!0), n = a.end; n > 0 && !l[n - 1];) n--;
                        0 === n && (n = i), a.begin = n, setTimeout(function () {
                            o(), s()
                        }, 0)
                    } else a.begin = _(!0), setTimeout(function () {
                        o(), s()
                    }, 0)
                }
                ...
                function $(t) {
                    if (!T.prop("readonly")) {
                        ...
                        f = T.val(), 8 === i || 46 === i || a && 127 === i ? (e = T.caret(), r = e.begin, o = e.end, o - r == 0 && (r = 46 !== i ? y(r) : o = h(r - 1), o = 46 === i ? h(o) : o), x(r, o), g(r, o - 1), t.preventDefault()) : 13 === i ? b.call(this, t) : 27 === i && (T.val(S), T.caret(0, _()), t.preventDefault())
                    }
                }

                function F(e) {
                    if (!T.prop("readonly")) {
                        var r, a, o, n = e.which || e.keyCode, d = T.caret();
                        if (!(e.ctrlKey || e.altKey || e.metaKey || n < 32) && n && 13 !== n) {
                            if (d.end - d.begin != 0 && (x(d.begin, d.end), g(d.begin, d.end - 1)), r = h(d.begin - 1), r < p && (a = String.fromCharCode(n), l[r].test(a))) {
                ...
                function _(t) {
                    ...
                    return t ? k() : i + 1 < c ? n.autoclear || P.join("") === E ? (T.val() && T.val(""), x(0, p)) : k() : (k(), T.val(T.val().substring(0, i + 1))), c ? e : m
                }

                var T = t(this), P = t.map(r.split(""), function (t, e) {
                ...
                }).on("blur.mask", b).on("keydown.mask", $).on("keypress.mask", F).on("input.mask paste.mask", function () {
    ...
    window.tildaBrowserLang = window.navigator.userLanguage || window.navigator.language, window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase(), -1 != window.tildaBrowserLang.indexOf("RU") ? window.tildaBrowserLang = "RU" : window.tildaBrowserLang = "EN", window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.tildaForm = {
        ...
        window.tildaForm.captchaCallback = function (t) {
            ...
            if (t.find(".js-tilda-rule").each(function () {
                var t, a, o = $(this).data("tilda-req") || 0, i = $(this).data("tilda-rule") || "none",
                    n = $(this).data("tilda-rule-minlength") || 0, s = $(this).data("tilda-rule-maxlength") || 0,
                    d = {}, l = $(this).val(), c = "";
                ...
                if (l.length > 0 && (r = !1), n && (n = parseInt(n)), s && (s = parseInt(s)), 1 == o && (0 == l.length && 0 == c.length || ("checkbox" == $(this).attr("type") || "radio" == $(this).attr("type")) && 0 == $(this).closest("form").find('[name="' + $(this).attr("name") + '"]:checked').length)) d.type.push("req"); else {
                    switch (i) {
                        case"email":
                        ...
                        case"date":
                            ...
                            c.length > 0 && !c.match(m[$(this).data("tilda-dateformat")] || /^[0-9]{1,4}[\-\.\/][0-9]{1,2}[\-\.\/][0-9]{1,4}$/gi) && d.type.push("date");
                            break;
                        case"time":
                        ...
                        case"string":
                            ...
                            break;
                        case"chosevalue":
                            var u = "true" === $(this).attr("data-option-selected");
                            u || d.type.push("chosevalue");
                            break;
                        case"deliveryreq":
                ...
                if (a) if (window.tcart.prodamount >= window.tcart_minorder) ; else {
                    var i = {};
                    i.obj = $({}), i.type = [], i.type.push("minorder"), e.push(i)
                }
                if (o) if (window.tcart.total >= window.tcart_mincntorder) ; else {
                    i = {};
            ...
            r || (r = ".blockinput");
            var a, o, i, n, s = window.tildaForm.arValidateErrors[window.tildaBrowserLang] || {}, d = "", l = "",
            ...
            var d = new Date, l = d.getTimezoneOffset();
            ...
            for (window.tcart.products && window.tcart.products.length > 0 && (u = window.tcart.products.length), window.tildaForm.tildapayment.products = [], r = 0; r < u; r += 1) {
                for (a in e = window.tcart.products[r], c = {}, m = "", window.tildaForm.tildapayment.products[r] = {}, e) if ("function" != typeof e[a]) if ("options" == a) for (var p in window.tildaForm.tildapayment.products[r][a] = {}, e[a]) void 0 === window.tildaForm.tildapayment.products[r][a][p] && (window.tildaForm.tildapayment.products[r][a][p] = {}), e[a][p].option && (window.tildaForm.tildapayment.products[r][a][p].option = e[a][p].option), e[a][p].price && e[a][p].price > 0 && (window.tildaForm.tildapayment.products[r][a][p].price = e[a][p].price), e[a][p].variant && (window.tildaForm.tildapayment.products[r][a][p].variant = e[a][p].variant), e[a][p].option && e[a][p].variant && (m > "" && (m += ", "), m = m + e[a][p].option + ":" + e[a][p].variant); else window.tildaForm.tildapayment.products[r][a] = e[a];
            ...
            var r = e.companyname, a = e.companylogo;
            if (r || (r = window.location.host), !window.stripehandler) {
                ...
                e.zipCode && 1 == e.zipCode && (o.zipCode = !0), e.billingAddress && 1 == e.billingAddress && (o.billingAddress = !0), e.shipping && 1 == e.shipping && (o.shippingAddress = !0), window.stripehandler = window.StripeCheckout.configure(o), $(window).on("popstate", function () {
            ...
            window.stripehandler.open({
                ...
                token: function (r, a) {
                    r && r.id && $.ajax({
                        ...
                        success: function (r) {
                            window.tildaForm.clearTCart(t);
                            var a = "/tilda/" + t.attr("id") + "/payment/", o = "Pay order in form " + t.attr("id"),
                                i = e.amount, n = e.description;
                            if (window.Tilda && "function" == typeof Tilda.sendEventToStatistics) {
            ...
            var r = e.currency, a = e.language, o = {};
            ...
            return n && 0 != n.length || (n = t.closest(".t706__cartwin_showed")), n.data("old-style", n.attr("style")), n.attr("style", "z-index:100"), window.tildaForm.orderIdForStat = e.invoiceId, e.skin || (e.skin = "classic"), window.cloudpaymentshandler.charge({
                publicId: e.publicId,
                description: e.description,
                ...
                var o = "/tilda/" + t.attr("id") + "/payment/", i = "Pay order in form " + t.attr("id"), s = e.amount,
                    d = e.description;
                $("#allrecords").data("tilda-currency", r), window.Tilda && "function" == typeof Tilda.sendEventToStatistics && Tilda.sendEventToStatistics(o, i, d, s), window.tildaForm.clearTCart(t), e.successurl > "" && window.setTimeout(function () {
                    window.location.href = e.successurl
                }, 300), t.data("successmessage") > "" ? t.find(".js-successbox").html(t.data("successmessage")) : t.find(".js-successbox").html(""), t.data("successmessage", "");
                var l = t.data("success-callback");
                window.tildaForm.successEnd(t, e.successurl, l), t.trigger("tildaform:aftersuccess")
            }, function (r, a) {
                if (n.attr("style", n.data("old-style")), t.find(".js-successbox").hide(), t.data("successmessage") > "" ? t.find(".js-successbox").html(t.data("successmessage")) : t.find(".js-successbox").html(""), t.data("successmessage", ""), window.cloudpaymentshandler = !1, e.failureurl > "") window.location.href = e.failureurl; else {
                    n.find(".t706__cartwin-products").show(), n.find(".t706__cartwin-prodamount-wrap").show(), n.find(".t706__form-bottom-text").show(), t.find(".t-form__inputsbox").show();
                    try {
                        tcart__lockScroll()
                    } catch (t) {
                    }
            ...
            if ($jform.find(".js-successbox").length > 0) {
                if ("y" == $jform.data("success-popup") && $jform.find(".js-successbox").hide(), arArgs.successmessage && arArgs.successmessage > "") $jform.find(".js-successbox").html(arArgs.successmessage); else if ($jform.data("successmessage") > "") $jform.find(".js-successbox").html($jform.data("successmessage")); else {
                    var arMessage = window.tildaForm.arMessages[window.tildaBrowserLang] || {};
            ...
            if (e && "fast" == e.condition) window.tildaForm.sendStatAndShowMessage(t, e, !0); else if (e && e.html > "") {
                $("#allrecords").append(e.html), $(".t-banktransfer .t-popup__close").off("click"), $(".t-banktransfer .t-popup__close").click(function () {
                ...
                a.length > 0 && (a.off("submit"), a.find(".t-submit").off("click"), a.find(".t-submit").off("dblclick"), a.submit(function (o) {
                    ...
                    $.ajax({
                        ...
                        error: function (t) {
                            $("body").removeClass("t-body_popupshowed"), a.remove(), alert(t)
                        },
                        timeout: 15e3
                    })
                }))
                ...
                return d = $jform.serializeArray(), window.tildaForm.tildapayment && window.tildaForm.tildapayment.amount && d.push({
                    ...
                    success: function (t) {
                        ...
                        if (btnformsubmit.removeClass("t-btn_sending"), btnformsubmit.data("form-sending-status", "0"), btnformsubmit.data("submitform", ""), t && t.length > 0) if ("{" == t.substring(0, 1)) {
                            if (e = window.JSON && window.JSON.parse ? window.JSON.parse(t) : $.parseJSON(t), e && e.message) "OK" != e.message && $jform.find(".js-successbox").html(e.message); else if (e && e.error) {
        ...
        $jallforms.length > 0 && $jallforms.each(function () {
            ...
            t.preventDefault();
            var e = $(this), r = e.data("form-sending-status");
            if (r >= "1") return !1;
            if ($(this).hasClass("t706__submit_disable")) return !1;
            var a = $(this).closest("form"), o = !1;
            ...
            var i = a.data("formactiontype"), n = $("#allrecords").data("tilda-formskey");
